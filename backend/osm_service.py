...
LOCAL_GEOCODE_FALLBACK = {
    ...
    "lonavala": {"lat": 18.7557, "lng": 73.4091, "display_name": "Lonavala, Maharashtra, India"},
    "gulmarg": {"lat": 34.0484, "lng": 74.3805, "display_name": "Gulmarg, Jammu & Kashmir, India"},
    "srinagar": {"lat": 34.0837, "lng": 74.7973, "display_name": "Srinagar, Jammu & Kashmir, India"},
    "amritsar": {"lat": 31.6340, "lng": 74.8723, "display_name": "Amritsar, Punjab, India"},
    "spiti valley": {"lat": 32.2460, "lng": 78.0340, "display_name": "Spiti Valley, Himachal Pradesh, India"},
    "auli": {"lat": 30.5312, "lng": 79.5658, "display_name": "Auli Ski Resort, Uttarakhand, India"},
    "dehradun": {"lat": 30.3165, "lng": 78.0322, "display_name": "Dehradun, Uttarakhand, India"},
    "nainital": {"lat": 29.3919, "lng": 79.4542, "display_name": "Nainital, Uttarakhand, India"},
    "gurgaon": {"lat": 28.4595, "lng": 77.0266, "display_name": "Gurgaon, Haryana, India"},
    "jodhpur": {"lat": 26.2389, "lng": 73.0243, "display_name": "Jodhpur, Rajasthan, India"},
    "jaisalmer": {"lat": 26.9157, "lng": 70.9083, "display_name": "Jaisalmer, Rajasthan, India"},
    "pushkar": {"lat": 26.4897, "lng": 74.5511, "display_name": "Pushkar, Rajasthan, India"},
    "bandhavgarh": {"lat": 23.7088, "lng": 81.0256, "display_name": "Bandhavgarh National Park, Madhya Pradesh, India"},
    "pachmarhi": {"lat": 22.4674, "lng": 78.4346, "display_name": "Pachmarhi Hill Station, Madhya Pradesh, India"},
    ...
    "khajuraho": {"lat": 24.8318, "lng": 79.9199, "display_name": "Khajuraho Temples, Madhya Pradesh, India"},
    "darjeeling": {"lat": 27.0410, "lng": 88.2627, "display_name": "Darjeeling, West Bengal, India"},
    "mysore": {"lat": 12.2958, "lng": 76.6394, "display_name": "Mysore, Karnataka, India"},
    "hampi": {"lat": 15.3350, "lng": 76.4600, "display_name": "Hampi Ruins, Karnataka, India"},
...
def fetch_osm_candidates(lat: float, lng: float, city_name: str):
    ...
    if not attractions:
        attractions = [
            {
                "id": "a_est_1",
                "name": f"Historic Heritage Temple & Ancient Sanctum ({city_name})",
                "category": "attraction",
                "cost_inr": 0.0,
                "lat": lat + 0.01,
                "lng": lng - 0.002,
                ...
                "reviews": ["Ancient architecture and peaceful sanctum.", "Serene spiritual atmosphere."],
                "image_url": ATTRACTION_IMAGES[0],
                "is_estimated": True
            },
            {
                "id": "a_est_2",
                "name": f"Panoramic Ridge & Sunset Viewpoint ({city_name})",
                "category": "attraction",
                "cost_inr": 0.0,
                "lat": lat - 0.005,
                "lng": lng + 0.008,
                ...
                "opening_hour": 15,
                "closing_hour": 19,
                "tags": ["nature", "viewpoint", "sunset"],
                "reviews": ["Breathtaking sunset views across the valley.", "Great photo spot with cool breeze."],
                "image_url": ATTRACTION_IMAGES[1] if len(ATTRACTION_IMAGES) > 1 else ATTRACTION_IMAGES[0],
                "is_estimated": True
            },
            {
                "id": "a_est_3",
                "name": f"Local Craft Bazaar & Silk Textile Market ({city_name})",
                "category": "attraction",
                "cost_inr": 50.0,
                "lat": lat + 0.001,
                "lng": lng + 0.003,
                ...
                "opening_hour": 10,
                "closing_hour": 20,
                "tags": ["shopping", "local_market", "crafts"],
                "reviews": ["Beautiful handmade souvenirs and traditional fabrics.", "Friendly local artisans and bargaining."],
                "image_url": ATTRACTION_IMAGES[2] if len(ATTRACTION_IMAGES) > 2 else ATTRACTION_IMAGES[0],
                "is_estimated": True
            },
            {
                "id": "a_est_4",
                "name": f"Cultural Museum & Heritage Art Pavilion ({city_name})",
                "category": "attraction",
                "cost_inr": 100.0,
                "lat": lat + 0.006,
                "lng": lng + 0.004,
                ...
                "reviews": ["Incredible historical artifacts and guided audio tour.", "Very well maintained galleries."],
                "image_url": ATTRACTION_IMAGES[3] if len(ATTRACTION_IMAGES) > 3 else ATTRACTION_IMAGES[0],
                "is_estimated": True
            },
            {
                "id": "a_est_5",
                "name": f"Botanical Eco Garden & Nature Trail ({city_name})",
                "category": "attraction",
                "cost_inr": 30.0,
                "lat": lat - 0.007,
                "lng": lng - 0.006,
                ...
                "opening_hour": 8,
                "closing_hour": 18,
                "tags": ["nature", "garden", "walking"],
                "reviews": ["Lush green trees and quiet walking paths.", "Perfect morning retreat away from city noise."],
                "image_url": ATTRACTION_IMAGES[0],
                "is_estimated": True
            },
            {
                "id": "a_est_6",
                "name": f"Sacred Lake Promenade & Meditation Ghat ({city_name})",
                "category": "attraction",
                "cost_inr": 0.0,
                "lat": lat + 0.003,
                "lng": lng - 0.007,
                ...
                "opening_hour": 6,
                "closing_hour": 20,
                "tags": ["spiritual", "lake", "relaxation"],
                "reviews": ["Very tranquil lake with gentle lotus ponds.", "Evening lighting and peaceful chanting."],
                "image_url": ATTRACTION_IMAGES[1] if len(ATTRACTION_IMAGES) > 1 else ATTRACTION_IMAGES[0],
                "is_estimated": True
            }
        ]
