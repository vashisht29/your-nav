...
from real_ground_transit_registry import get_verified_ground_transfer

def get_ground_transfer_intelligence(airport_iata: str, dest_name: str, travelers: int = 1) -> dict:
    """
    Returns verified ground transport services from authentic Indian Railways (IRCTC),
    State Road Transport Corporations (UTC, HRTC, TNSTC), and Airport Taxi Unions.
    """
    return get_verified_ground_transfer(airport_iata, dest_name, travelers)
